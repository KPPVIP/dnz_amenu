...
RegisterCommand("amenu", function(source, args)
    ...
    ESX.TriggerServerCallback('dnz_amenu:getGroup', function(grp)
        if grp ~= 'user' then
            TriggerEvent('dnz_amenu:getAdmins')
...
RegisterNUICallback("action", function(data)
    ...
    if data.da == 'kick' then
        TriggerServerEvent('dnz_amenu:kickbru', data.target, data.grund)
...
RegisterNUICallback("banlist", function(data)
	ESX.TriggerServerCallback('dnz_amenu:getbanlist', function(banList)
		local BanList
...
RegisterNUICallback("main", function(data)
    ESX.TriggerServerCallback('dnz_amenu:getInfo', function(infos, loadout, inventory)
        SendNUIMessage({
            type = "invhr"
        })
...
RegisterNetEvent('dnz_amenu:getAdmins')
AddEventHandler('dnz_amenu:getAdmins', function()
    ESX.TriggerServerCallback('dnz_amenu:getAdmins', function(tbl)
        SendNUIMessage({
            type = "setplayers",
            admins = tbl.admins,
            players = tbl.players
...
function getPlayers()
	local players = {}
	ESX.TriggerServerCallback('dnz_amenu:getPlayers', function(www)
		www = json.decode(www)
